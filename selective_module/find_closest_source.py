...
#output
adp_dir='../result/adapt_slective_pt/adapt_iter5_pt/'   #'../result/gta2citys_pt/steps265000'
...
gta5_dir = '/home/zq/dl-test/ZQAdaptSegNet-master/data/GTA5/labels'#'../data/GTA5/labels/'
...
if os.path.isfile(gta5_cls_distr_path)==False:
    ...
    for i in range(0, gta5_list_num):
        ...
        png_path = os.path.join(gta5_dir , gta5_list[i])
        png = np.array(Image.open(png_path))
        png_flat = png.flatten()
