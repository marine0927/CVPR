...
save_path='../result/original_closest15000/{0}'
...
def compute_mIoU(gt_dir, pred_dir, devkit_dir=''):
    ...
    print('===> mIoU: ' + str(round(np.nanmean(mIoUs) * 100, 2))+' '+str(round(np.nanmean(syn_mIoUs) * 100, 2)))
    return mIoUs,syn_mIoUs

def show_val(seg_state_dict,show_pred_sv_dir):
