...
from NTHU_show_val import show_val
...
DATA_DIRECTORY_TARGET = 'G:/data/NTHU_Datasets/Tokyo'
DATA_LIST_PATH_TARGET = './dataset/NTHU_list/TOKYO_train.txt'
...
SNAPSHOT_DIR = './snapshots/city2cross/'
pre_sv_dir='./result/city2cross/steps{0}'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    trainloader = data.DataLoader(
        cityscapesDataSet(args.data_dir, args.data_list, max_iters=args.num_steps * args.iter_size * args.batch_size,
                    ...
                    scale=args.random_scale, mirror=args.random_mirror, mean=CITY_IMG_MEAN),
        batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=True)

    trainloader_iter = enumerate(trainloader)

    targetloader = data.DataLoader(NTHUDataSet(args.data_dir_target, args.data_list_target,
                                                     max_iters=args.num_steps * args.iter_size * args.batch_size,
                                                     crop_size=input_size_target,
                                                     scale=False, mirror=args.random_mirror, mean=TOKYO_IMG_MEAN,
                                                     set=args.set),
