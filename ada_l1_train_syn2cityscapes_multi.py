...
SNAPSHOT_DIR = './snapshots/synthia_original/ada_l1_0.0001_80000_order/'
WEIGHT_DECAY = 0.0005
...
#continue
continue_start_iter=7500
CONTINUE_FLAG=1
if CONTINUE_FLAG==1:
    RESTORE_FROM = './snapshots/synthia_original/ada_l1_0.0001_80000_order/GTA5_7500.pth'
    D1_RESTORE_FROM='./snapshots/synthia_original/ada_l1_0.0001_80000_order/GTA5_7500_D1.pth'
    D2_RESTORE_FROM='./snapshots/synthia_original/ada_l1_0.0001_80000_order/GTA5_7500_D1.pth'
