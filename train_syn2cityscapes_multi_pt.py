...
# DATA_LIST_PATH = './dataset/synthia_list/train_fine3.txt'
...
# SNAPSHOT_DIR = '/mnt/sda/zq2/ZQAdaptSegNet/snapshots/syn2citys_fine3/'
# pre_sv_dir='./result/syn2citys_fine3/steps{0}'
WEIGHT_DECAY = 0.0005
    ...
    for i_iter in range(args.num_steps):
        ...
        if i_iter % args.save_pred_every == 0 and i_iter != 0:
            ...
            for miou in mIoUs:
                ...
                print_i = print_i + 1
                sum_iou+=float(miou)
                mean_IoU=sum_iou/len(mIoUs)
            print('mean_IoU:{0}'.format(mean_IoU))
