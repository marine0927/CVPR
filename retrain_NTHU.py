...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = 'G:/data/NTHU_Datasets/Tokyo'
DATA_LIST_PATH ='./dataset/NTHU_list/TOKYO_test.txt'
IGNORE_LABEL = 255
# INPUT_SIZE = '1280,720'
INPUT_SIZE = '1024,512'
...
# RESTORE_FROM='./snapshots/retrain_mixed' + str(adapt_iter) + '_j0.3/GTA5_' + str(strat_snap_iter) + '.pth'
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 50
SNAPSHOT_DIR = './snapshots/retrain_NTHU_tokyo'
pre_sv_dir='./result/retrain_NTHU_tokyo1/steps{0}'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    for i_iter in range(args.num_steps):
        ...
        # loss2_sum_per_epoch += loss_seg2.data.cpu().numpy()[0]
