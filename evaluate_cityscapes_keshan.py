...
SAVE_PATH = './result/gta2citys_pt2/steps32500'
if not os.path.exists(SAVE_PATH):
    os.makedirs(SAVE_PATH)
'/mnt/sda/zq2/ZQAdaptSegNet/snapshots/gta2citys_pt/'
IGNORE_LABEL = 255
NUM_CLASSES = 19
NUM_STEPS = 500 # Number of images in the validation set.
RESTORE_FROM = 'http://vllab.ucmerced.edu/ytsai/CVPR18/GTA2Cityscapes_multi-ed35151c.pth'
# RESTORE_FROM='./model/GTA2Cityscapes_multi-ed35151c.pth'
RESTORE_FROM='/mnt/sda/zq2/ZQAdaptSegNet/snapshots/gta2citys_pt/GTA5_32500.pth'
# SET = 'train'
SET = 'val'
